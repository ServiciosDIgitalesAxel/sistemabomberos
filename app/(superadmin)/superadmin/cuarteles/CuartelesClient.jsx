...
export default function CuartelesClient({ cuarteles: inicial, session }) {
  ...
  return (
    <div className="min-h-screen bg-[#020810] flex flex-col">
      ...
      <div className="flex-1 px-5 py-6 flex flex-col gap-4 max-w-2xl mx-auto w-full">
          ...
          <form onSubmit={handleCrear}
            ...
            <div className="flex flex-col gap-1">
              ...
              <input type="text" value={nombre}
                     ...
                     required placeholder="Ej: Bomberos Villa del Rosario"
            ...
            <div className="border-t border-white/10 pt-4">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex flex-col gap-1">
                  ...
                  <input type="text" value={adminNombre}
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input type="text" value={adminJerarquia}
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input type="text" value={adminUsername}
                         ...
                         required placeholder="Nombre de usuario para login"
                         autoComplete="off"
                         className="bg-white/8 border border-white/10 rounded-lg px-3 py-2.5
                                    text-white placeholder-white/30 text-sm
                                    focus:outline-none focus:border-white/30" />
