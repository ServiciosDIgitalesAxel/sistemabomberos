...
export async function POST(request) {
  ...
  // ✅ Se agregan hora_inicio, hora_fin, dias_semana a la desestructuración
  const { nombre, icono, color, tipo_base, estados, orden, hora_inicio, hora_fin, dias_semana } = await request.json()
  if (!nombre || !tipo_base) {
...
export async function PATCH(request) {
  ...
  // ✅ Se agregan hora_inicio, hora_fin, dias_semana a la desestructuración
  const { id, nombre, icono, color, estados, activo, orden, hora_inicio, hora_fin, dias_semana } = await request.json()
  ...
  // ✅ Bloque de notificación movido DENTRO de PATCH, donde id y hora_* están en scope
